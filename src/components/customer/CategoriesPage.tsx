  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-6">
        <h2 className="text-xl font-bold text-gray-900 mb-6">{t('categories.allCategories')}</h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          {categories.map((cat, index) => (
            ...
            >
              ...
              <p className="text-xs text-gray-500 mt-1">{cat._count?.products || 0} {t('categories.products')}</p>
              <div className="flex items-center gap-1 mt-3 text-[#0C831F]">
                <span className="text-xs font-medium">{t('categories.browse')}</span>
